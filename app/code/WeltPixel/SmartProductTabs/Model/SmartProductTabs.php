 ...
 */
class SmartProductTabs extends \Magento\Rule\Model\AbstractModel
{
    const CACHE_TAG = 'weltixel_smartproducttabs';

    /**
     * @var string
     */
    protected $_cacheTag = 'weltixel_smartproducttabs';
     ...
     * @var string
     */
    protected $_eventPrefix = 'weltixel_smartproducttabs';
    ...
    {
        $this->_init('WeltPixel\SmartProductTabs\Model\ResourceModel\SmartProductTabs');
    }
