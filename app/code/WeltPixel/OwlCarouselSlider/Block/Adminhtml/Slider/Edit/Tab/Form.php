...
class Form extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $elements['nav_border_radius'] = $fieldset->addField(
            'nav_border_radius',
            'text',
            [
                'name'     => 'nav_border_radius',
                'label'    => __('Prev/Next button border radius'),
                'title'    => __('Prev/Next button border radius'),
                'required' => false,
                'note'    => 'Specify in px or %, default 3px',
            ]
        );
