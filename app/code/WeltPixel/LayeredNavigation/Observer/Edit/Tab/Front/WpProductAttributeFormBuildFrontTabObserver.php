    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'title' => __('Allow to keep attribute open after filtering. Only available in PRO version of this extension. <br>
                ...
                'note' => __('Allow to keep attribute open after filtering. Only available in PRO version of this extension. <br>
                                <a style="font-size: 14px" target="_blank" href="https://www.weltpixel.com/magento2-layered-navigation.html">Upgrade to Pro version</a> to enable this functionality.')
            ]
        );
                       ...
                       require(['jquery', 'jquery/ui'], function($){
                            ...
                            */
                            function setWpVisibility(){
                                ...
                                disableElement(wpKeepAttributeOpenEl);
